...
<div class="container mt-4">
    ...
    <!-- [NEW] Show success message if schedule_deleted=1 -->
    ...
    <form method="GET" class="row gy-2 gx-3 align-items-end" action="/">
        <!-- Filter fields (existing code) -->
        <!-- ... -->
    </form>

    <a href="/schedule/create" class="btn btn-sm btn-success mt-4">Create New Schedule</a>
    <hr>
