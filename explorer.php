 ...
 * explorer.php
 *
 * A single-file script that recursively displays a file tree with:
 * - Folder expand/collapse
 * - File content display on click
 * - "Expand All", "Collapse All", and "Open All File Contents" features
 * - The script itself is not displayed in the file tree.
 */

// 1. Define the root directory you want to explore.
